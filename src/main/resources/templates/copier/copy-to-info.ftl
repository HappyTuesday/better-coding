...
<#-- @ftlvariable name="targetProxy" type="io.nick.plugin.better.coding.proxy.InfoProxy" -->
<#-- @ftlvariable name="sourceProxy" type="io.nick.plugin.better.coding.proxy.DtoProxy" -->
