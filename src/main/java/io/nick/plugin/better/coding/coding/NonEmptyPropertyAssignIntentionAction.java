...
public class NonEmptyPropertyAssignIntentionAction extends PropertyAssignIntentionAction {
    @Override
    public @NotNull String getText() {
        return "Assign non empty properties";
    }

    @Override
    protected void processAssignExpression(Project project, PsiClass currentType, PsiAssignmentExpression assign, Editor editor) {
        generateAssignments(project, currentType, assign, CodeTemplate.getTemplate("assign/non-empty.ftl"));
    }
}
