...
public class NonBlankPropertyAssignIntentionAction extends PropertyAssignIntentionAction {
    @Override
    public @NotNull String getText() {
        return "Assign non blank properties";
    }

    @Override
    protected void processAssignExpression(Project project, PsiClass currentType, PsiAssignmentExpression assign, Editor editor) {
        generateAssignments(project, currentType, assign, CodeTemplate.getTemplate("assign/non-blank.ftl"));
    }
}
